...
# Toggle untuk membuka dan menutup catatan kata kunci
...
def colored_metric(label, value, color):
    st.markdown(f"""
    <div style="padding: 5px; border-radius: 3px; background-color: {color}; color: white; text-align: center;">
        <h4>{label}</h4>
...
# Menampilkan hasil klasifikasi untuk kategori usaha
with col1:
    colored_metric2("Akurasi", "84,71%", "#FF9800")
with col2:
    colored_metric2("Presisi", "72,99%", "#4CAF50")
with col3:
